...
<div>
 ...
 @csrf
  ...
  <div class="form-group">
    ...
    <input type="name" name="cus_name" class="form-control" id="exampleInputName" placeholder="">
  </div>
  <br><br>

  <div class="form-group">
    <label for="exampleInputContactNo">Contact No</label>
    <input type="text" name="contact_No" class="form-control" id="exampleInputContactNo" placeholder="">
  </div>
  <br><br>
  ...
  <div class="form-group">
    ...
    <input type="text" name="book_ID" class="form-control" id="exampleInputBookID" placeholder="">
  </div>
  <br><br>

  <div class="form-group">
    <label for="exampleInputRoomID">Room ID</label>
    <input type="text" name="room_ID" class="form-control" id="exampleInputRoomID" placeholder="">
  </div>
  <br><br>

  <div class="form-group">
    <label for="exampleInputCIdate">Checked In Date</label>
    <input type="date" name="checked_in" class="form-control" id="exampleInputCDdate" placeholder="">
  </div>
  <br><br>

  <div class="form-group">
    <label for="exampleInputCOdate">Check out Date</label>
    <input type="date" name="checked_out" class="form-control" id="exampleInputCOdate" placeholder="">
  </div>
  <br><br>
