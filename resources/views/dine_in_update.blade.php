...
<html>
    <head>
        <title>Inventory Management - Update Menu</title>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="menuBody">
                    ...
                    <form method="post" id="#validate_form" action="{{ route('dinein.update',$dineIn->id) }}" data-parsley-validate="">
                    @csrf <!-- {{ csrf_field() }} -->
                    @method('PATCH')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $dineIn->meal_code }}" id="meal_code" placeholder="" name="meal_code" required data-parsley-minlength="3" data-parsley-trigger="keyup">
                    </div>

                    <div class="form-group">
                        <label for="menu">Menu</label>
                        <textarea class="form-control" id="menu" placeholder="" name="menu" required data-parsley-trigger="keyup">{{ $dineIn->menu }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="small">Small Poriton Price</label>
                        <input type="text" class="form-control" id="small" value="{{ $dineIn->small_portion_price }}" placeholder="" name="small_portion_price" required data-parsley-type="digits" data-parsley-trigger="keyup">
                    </div>

                    <div class="form-group">
                        <label for="medium">Medium Poriton Price</label>
                        <input type="text" class="form-control" id="medium" value="{{ $dineIn->medium_portion_price }}" placeholder="" name="medium_portion_price" 	data-parsley-type="digits" data-parsley-trigger="keyup">
                    </div>

                    <div class="form-group">
                        <label for="laege">Laege Poriton Price</label>
                        <input type="text" class="form-control" id="laege" value="{{ $dineIn->large_portion_price }}" placeholder="" name="large_portion_price" data-parsley-type="digits" data-parsley-trigger="keyup">
                    </div>
